...
Project X is a robotics project developed by the GMHS BotBall Team 504. The project aims to create a robot that can perform various tasks autonomously using a combination of sensors, motors, and servos. The project is built using C and CMake, and it is designed to run on the KIPR Wombat controller.
